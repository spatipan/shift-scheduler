...
from modules.scheduler_app.solver import ScheduleSolver, SchedulerConstraint
...
class SchedulerApp:
    def __init__(self):
        self.google_app_authenticator = GoogleAppAuthenticator(credentials_path=config.CREDS_PATH,
    ...
    def update_information(self):
        self.sheet_ui.update_sheet_values(schedule=self.schedule) # type: ignore
